...
public:
    ...
    // Retorna a AABB (caixa alinhada com eixos) que envolve a primitiva.
    // Usada pela BVH para construir a hierarquia de volumes.
    ...
    /*!
     * @brief Define/atualiza o material desta primitiva.
     *
     * Usado, por exemplo, pelos triangulos de uma malha, que sao criados
     * primeiro e so depois recebem o material da cena.
     */
